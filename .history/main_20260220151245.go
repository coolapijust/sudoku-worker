...
//go:linkname allGridsData allGridsData
//go:linkname hintPositionsData hintPositionsData
//go:linkname encodeTable encodeTable
//go:linkname encodeTableCount encodeTableCount
//go:linkname decodeTableKeys decodeTableKeys
//go:linkname decodeTableVals decodeTableVals
